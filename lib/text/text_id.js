...
Punya Kritik/Saran atau ingin Request Fitur ? atau ingin bertanya tentang bot ? Silahkan follow Instagram Developer *@bayuganz_665* 
...
Agar bot dapat bertahan dan hidup 24 Jam kalian bisa bantu donasi dengan nomor dibawah ini
...
Silahkan kontak Developer di Instagram *@bayuganz_665*
`;
...
Silahkan membuat isu jika kalian menemukan bug pada Bot atau ada perintah yag tidak dapat berjalan. Silahkan kontak developer melalui DM Instagram di *@bayuganz_665*
`;
...
― Mari berkenalan melalui Instagram *@bayuganz_665*
`;
